...
function reifyTextureViewDescriptor(texture, desc) {
    const { format = texture.format, dimension = texture.dimension === '2d'
        ? (texture.depthOrArrayLayers === 1 ? '2d' : '2d-array')
        : texture.dimension, aspect = 'all', baseMipLevel = 0, mipLevelCount = texture.mipLevelCount, baseArrayLayer = 0, arrayLayerCount = texture.depthOrArrayLayers, } = desc || {};
    return {
